...
import com.jules.tutorialmod.item.ModItems;
    ...
    public TutorialMod()
    {
        ...
        modEventBus.register(TutorialConfig.class);
    }
    ...
    private void commonSetup(final FMLCommonSetupEvent event)
    {
        ...
        if (TutorialConfig.logDirtBlock.get())
            LOGGER.info("DIRT BLOCK >> {}", ForgeRegistries.BLOCKS.getKey(Blocks.DIRT));

        LOGGER.info(TutorialConfig.magicNumberIntroduction.get() + TutorialConfig.magicNumber.get());

        TutorialConfig.items.get().forEach((item) -> LOGGER.info("ITEM >> {}", item.toString()));
    }
